...
public class GameManager : MonoBehaviour 
{
	...
	public TempSet<float> xangset = new TempSet<float>(3f);
	public TempSet<float> yangset = new TempSet<float>(3f);
	public TempSet<float> zangset = new TempSet<float>(3f);
	public TempSet<float> lc1set = new TempSet<float>(3f);
	public TempSet<float> lc2set = new TempSet<float>(3f);
	public TempSet<float> pressset = new TempSet<float>(3f);
